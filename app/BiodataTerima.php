...
class BiodataTerima extends Model
{
  protected $table = 'biodata_terima';
  protected $fillable = [
    ...
    'pil1', 'pil2', 'tempat_lahir', 'kode_slta', 'nama_slta', 'kabupaten', 'provinsi', 'tahun_lulus', 'kode_tahun_akademik','tgl_lahir',
    ];
}
