...
Route::get('/resetsbmptn','NASController@resetsbmptn');
Route::post('/sbmptnimportreset','NASController@sbmptnimportreset');
Route::get('/api/sbmptn/{kode_prodi}/{tahun}','NASController@apisbmptn');
...
Route::get('/fileprestasi','DashboardController@fileprestasi');
Route::post('/addedfileprestasi','DashboardController@addedfileprestasi');
