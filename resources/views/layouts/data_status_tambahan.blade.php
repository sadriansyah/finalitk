            ...
            <div class="card">
                <div class="header">
                                <div class="block-header">
                                    <h2>Data Status Tambahan</h2>
                                </div>
                        <form action="{{url('/data_status_tambahan')}}" method="get">
                          @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Status Tambahan</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importDataStatusTambahan')}}" method="post" enctype="multipart/form-data">
                  @csrf
