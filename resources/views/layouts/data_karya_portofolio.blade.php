            ...
            <div class="card">
                <div class="header">
                                <div class="block-header">
                                    <h2>Data Karya Portofolio</h2>
                                </div>
                        <form action="{{url('/data_karya_portofolio')}}" method="get">
                          @csrf
                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                @foreach($karya as $d)
                                    <tr>
                                        <th>{{$i}}</th>
                                        <td>{{$d->id_karya_portofolio}}</td>
                                        <td>{{$d->nomor_pendaftaran}}</td>
                                        <td>{{$d->id_portofolio}}</td>
                                        <td>{{$d->judul_karya}}</td>
                                        <td>{{$d->file_karya}}</td>
                                    </tr>
                                    <?php
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Karya Portofolio</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importDataKaryaPortofolio')}}" method="post" enctype="multipart/form-data">
                  @csrf
