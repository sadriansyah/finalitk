            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>Data Nilai UN SMA dan SMK </h2>
                    </div>
                    <form action="{{url('/data_nilai_un_sma')}}" method="get">
                      @csrf
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>{{$p->nilai_skala_4}}</td>
                                      <td>{{$p->nilai_skala_100}}</td>
                                      <td>{{$p->tahun_kur}}</td>
                                      <td>{{$p->basis}}</td>
                                      <td>{{$p->unit}}</td>
                                      <td>{{$p->kkm}}</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Nilai UN SMA dan SMK</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importDataNilaiUNSMA')}}" method="post" enctype="multipart/form-data">
                  @csrf
