        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <a href="{{asset('master_sbmptn/Template Rataan Prodi SBMPTN.xlsx')}}">
                    Download Template SBMPTN Rataan Prodi (Khusus SBMPTN harap mengikuti format yang telah disediakan)
                  </a>
              </div>
            </div>
