            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>Data Nilai Soshum Per PTN</h2>
                    </div>
                    <form action="{{url('/terima_soshum')}}" method="get">
                      @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Nilai PTN Soshum</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importTerimaSoshum')}}" method="post" enctype="multipart/form-data">
                  @csrf
              ...
              <div class="form-group">
                  ...
                  <a href="{{asset('master_sbmptn/Template PTN_Nilai_Terima_Soshum SBMPTN.xlsx')}}">
                    Download Template SBMPTN Nilai Terima Soshum (Khusus SBMPTN harap mengikuti format yang telah disediakan)
                  </a>
              </div>
            </div>
