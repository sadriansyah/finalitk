            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>Data Terima Per PTN</h2>
                    </div>
                    <form action="{{url('/terima_ptn')}}" method="get">
                      @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Terima Per PTN</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importTerimaPTN')}}" method="post" enctype="multipart/form-data">
                  @csrf
              ...
              <div class="form-group">
                  ...
                  <a href="{{asset('master_sbmptn/Template Terima Per PTN SBMPTN.xlsx')}}">
                    Download Template SBMPTN Terima Per PTN (Khusus SBMPTN harap mengikuti format yang telah disediakan)
                  </a>
