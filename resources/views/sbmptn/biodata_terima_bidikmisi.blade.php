...
<div class="container-fluid">
            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{url('/biodata_bidikmisi')}}" method="get">
                      @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{url('/importBiodataTerimaBidikmisi')}}" method="post" enctype="multipart/form-data">
                  @csrf
              ...
              <div class="form-group">
                  ...
                  <a href="{{asset('master_sbmptn/Template Biodata Terima Bidikmisi SBMPTN.xlsx')}}">
                    Download Template SBMPTN Biodata Terima Bidikmisi (Khusus SBMPTN harap mengikuti format yang telah disediakan)
                  </a>
              </div>
            </div>
