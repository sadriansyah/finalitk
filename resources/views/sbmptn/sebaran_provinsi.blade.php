            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>Data Sebaran Provinsi</h2>
                    </div>
                    <form action="{{url('/sebaran_provinsi')}}" method="get">
                      @csrf
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nama Prodi</th>
                                        <th>Nama Provinsi</th>
                                        <th>Jumlah Peminat 1</th>
                                        <th>Jumlah Peminat 2</th>
                                        <th>Total Jumlah Peminat </th>
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                @foreach($sebaran as $d)
                                    <tr>
                                        <th>{{$i}}</th>
                                        <td>{{$d->kode_prodi}}</td>
                                        <td>{{$d->nama_prodi}}</td>
                                        <td>{{$d->nama_provinsi}}</td>
                                        <td>{{$d->jumlah_peminat1}}</td>
                                        <td>{{$d->jumlah_peminat2}}</td>
                                        <td>{{$d->jumlah_peminat}}</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Sebaran Provinsi</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importSebaranProvinsi')}}" method="post" enctype="multipart/form-data">
                  @csrf
              ...
              <div class="form-group">
                  ...
                  <a href="{{asset('master_sbmptn/Template Sebaran Provinsi SBMPTN.xlsx')}}">
                    Download Template SBMPTN Sebaran Provinsi (Khusus SBMPTN harap mengikuti format yang telah disediakan)
                  </a>
              </div>
            </div>
