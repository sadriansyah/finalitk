            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>Data Biodata Peminat</h2>
                    </div>
                    <form action="{{url('/biodata_peminat')}}" method="get">
                      @csrf
                                ...
                                <tbody>
                                  @foreach($biodata as $p)
                                    <tr>
                                      ...
                                      <td>{{$p->nilai_terima}}</td>
                                      <td>{{$p->nama_slta}}</td>
                                      <td>{{$p->kabupaten}}</td>
                                      <td>{{$p->provinsi}}</td>
                                      <td>{{$p->tahun_lulus}}</td>
                                      <td>{{$p->jurusan_slta}}</td>
                                    </tr>
                                  @endforeach
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Biodata Peminat</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importBiodataPeminat')}}" method="post" enctype="multipart/form-data">
                  @csrf
              ...
              <div class="form-group">
                  ...
                  <a href="{{asset('master_sbmptn/Template Biodata Peminat SBMPTN.xlsx')}}">
                    Download Template SBMPTN Biodata Peminat (Khusus SBMPTN harap mengikuti format yang telah disediakan)
                  </a>
              </div>
            </div>
