            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>Data Keketatan Saintek</h2>
                    </div>
                    <form action="{{url('/keketatan_saintek')}}" method="get">
                      @csrf
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <td rowspan="2" class="text-center">PTN</td>
                                        <td colspan="4" class="text-center">Jumlah Peminat</td>
                                        <td rowspan="2" class="text-center">Terima</td>
                                        <td rowspan="2" class="text-center">Keketatan Persaingan (%)</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Keketatan Saintek</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importKeketatanSaintek')}}" method="post" enctype="multipart/form-data">
                  @csrf
              ...
              <div class="form-group">
                  ...
                  <a href="{{asset('master_sbmptn/Template Keketatan Saintek SBMPTN.xlsx')}}">
                    Download Template SBMPTN Keketatan Saintek (Khusus SBMPTN harap mengikuti format yang telah disediakan)
                  </a>
              </div>
            </div>
